...
<body class="hold-transition login-page" style="background-color:#000">
  <div class="login-box">
    ...
    <div class="alert alert-danger alert-dismissible">
      ...
      <h5><i class="icon fas fa-exclamation"></i> Login e/ou senha incorretos!</h5>
    </div>
    <?php } ?>
    <div class="card">
      <div class="card-body login-card-body" style="background-color: #2b2b2b;background-image: linear-gradient(#000,#2b2b2b);">
        ...
        <div class="social-auth-links text-center mb-3">
          <p>- OU -</p>
          <a href="login/recuperar-senha" class="btn btn-block btn-primary">
            <i class="fa fa-reload"></i> Esqueci minha senha
          </a>
        </div>
      </div>
      <!-- /.login-card-body -->
