          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button class="btn btn-info"><i class="fa fa-upload"></i> Importar XML</button>
                <button class="btn btn-info"><i class="fa fa-download"></i> Exportar cartórios para excel</button>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
